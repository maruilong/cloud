...
<head>
    <meta charset="utf-8">
    <title>登录界面</title>
    <link rel="stylesheet" href="/sso/css/reset.css"/>
    <link rel="stylesheet" href="/sso/css/common.css"/>
    <link rel="stylesheet" href="/sso/css/font-awesome.min.css"/>
</head>
<body>
...
<script type="text/javascript" src="/sso/js/jquery.min.js"></script>
